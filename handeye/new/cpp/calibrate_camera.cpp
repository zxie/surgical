...
int main(int argc, char* argv[]) {
 ...
 // assert( capture );
  ...
  //ALLOCATE STORAGE
  CvMat* image_points      = cv::Mat(n_boards*board_n,2,CV_32FC1);
  CvMat* object_points     = cv::Mat(n_boards*board_n,3,CV_32FC1);
  CvMat* point_counts      = cv::Mat(n_boards,1,CV_32SC1);
  CvMat* intrinsic_matrix  = cv::Mat(3,3,CV_32FC1);
  CvMat* distortion_coeffs = cv::Mat(4,1,CV_32FC1);
 ...
 //      cvShowImage( "Calibration", image );
  ...
  CvMat* object_points2  = cv::Mat(successes*board_n,3,CV_32FC1);
  CvMat* image_points2   = cv::Mat(successes*board_n,2,CV_32FC1);
  CvMat* point_counts2   = cv::Mat(successes,1,CV_32SC1);
